...
const exchangeRates = {
    "10/9": { "10/9": 1, "8/6": 2, "5/3": 4, "2/1": 6, "0.9/0.3": 8, "0.25": 10 },
    "8/6": { "10/9": 0.5, "8/6": 1, "5/3": 2, "2/1": 4, "0.9/0.3": 6, "0.25": 8 },
    "5/3": { "10/9": 0.25, "8/6": 0.5, "5/3": 1, "2/1": 2, "0.9/0.3": 4, "0.25": 6 },
    "2/1": { "10/9": 0.167, "8/6": 0.25, "5/3": 0.5, "2/1": 1, "0.9/0.3": 2, "0.25": 4 },
    "0.9/0.3": { "10/9": 0.125, "8/6": 0.167, "5/3": 0.25, "2/1": 0.5, "0.9/0.3": 1, "0.25": 2 },
    "0.25": { "10/9": 0.1, "8/6": 0.125, "5/3": 0.167, "2/1": 0.25, "0.9/0.3": 0.5, "0.25": 1 }
  };
...
const Exchange = props => {
  ...
  useEffect(() => {
    ...
    const receivedQuantity = calculateReceivedQuantity(
      tradedParagons,
      desiredParagon.type
    );

    const newDesiredParagon = {
      ...desiredParagon,
      quantity: receivedQuantity,
    };

    props.onChange({
      desiredParagon: newDesiredParagon,
      tradedParagons,
    });
